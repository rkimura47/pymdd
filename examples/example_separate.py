...
mymdd.compile_trivial(numLayers, domain, lambda d,j: costFunc(None,d,j,None), lambda j: None)
mymdd.filter_and_refine_constraint(trFunc, rootState, isFeas, maxWidth)
